...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
            ...
            rectified_linear_unit_vectorized = np.vectorize(rectified_linear_unit)
            rectified_linear_unit_derivative_vectorized = np.vectorize(rectified_linear_unit_derivative)
            output_layer_activation_derivative_vectorized = np.vectorize(output_layer_activation_derivative)
            ...
            # Compute gradients
            output_layer_error = np.multiply((activated_output - y), output_layer_activation_derivative_vectorized(output))
            hidden_layer_error = np.multiply(self.hidden_to_output_weights.T @ output_layer_error, rectified_linear_unit_derivative_vectorized(hidden_layer_weighted_input))
    ...
    def predict(self, x1, x2):
            ...
            activated_output = output_layer_activation(output)  # Assuming you have defined the output_layer_activation function
