...
def run_svm_one_vs_rest_on_MNIST(c_in=0.01):
    """
    ...
    train_y[train_y != 0] = 1
    test_y[test_y != 0] = 1
    pred_test_y = one_vs_rest_svm(train_x, train_y, test_x,c_in)
...
#print('SVM one vs. rest test_error:(c=1.0)', run_svm_one_vs_rest_on_MNIST(1.0))
...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    # Update the labels for train_y and test_y to mod 3 labels
    train_y_mod3, test_y_mod3 = update_y(train_y, test_y)
    
    # Compute the test error for the new labels
    test_error_mod3 = compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter)
    
    print(f"Test error using mod 3 labels: {test_error_mod3}")
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    # Train softmax regression on the updated train_y_mod3
    ...
    # Compute the test error on the updated test_y_mod3
    test_error_mod3 = compute_test_error_mod3(test_x, test_y_mod3, theta, temp_parameter)
    
    # Save the model parameters theta obtained from calling softmax_regression to disk
    write_pickle_data(theta, "./theta_mod3.pkl.gz")
    
    print(f"Test error using mod 3 labels: {test_error_mod3:.4f}")

    return test_error_mod3


# TODO: Run run_softmax_on_MNIST_mod3(), report the error rate
print("running softmax on minst mod3")
